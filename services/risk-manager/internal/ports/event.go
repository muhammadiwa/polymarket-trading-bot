...
type CorrelationRejectionEvent struct {
	EventID   string                        `json:"event_id"`
	EventType string                        `json:"event_type"`
	Timestamp time.Time                     `json:"timestamp"`
	Source    string                        `json:"source"`
	Payload   CorrelationRejectionPayload   `json:"payload"`
}

type CorrelationRejectionPayload struct {
	MarketID       string   `json:"market_id"`
...
type BatasiWinTriggered struct {
	...
	Timestamp time.Time            `json:"timestamp"`
	Source    string               `json:"source"`
	Payload   BatasiWinPayload     `json:"payload"`
}

type BatasiWinPayload struct {
...
type MetabolicRateAlert struct {
	...
	Timestamp time.Time              `json:"timestamp"`
	Source    string                 `json:"source"`
	Payload   MetabolicRatePayload   `json:"payload"`
}

type MetabolicRatePayload struct {
...
type EventPublisher interface {
	...
	PublishCorrelationRejection(ctx context.Context, event CorrelationRejectionEvent) error
	PublishBatasiWinTriggered(ctx context.Context, event BatasiWinTriggered) error
	PublishMetabolicRateAlert(ctx context.Context, event MetabolicRateAlert) error
	Close() error
}
...
type EventSubscriber interface {
	...
	SubscribeRiskCommand(ctx context.Context, handler func(map[string]interface{})) error
	Close() error
}
